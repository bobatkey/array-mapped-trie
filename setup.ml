...
(* OASIS_START *)
(* DO NOT EDIT (digest: 59fd078728a671f650be69cbccb8aaef) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A hash tree data structure implementation";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Hashtree"; "Hashtree_packed"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "N*\0127\138N?\253e\190i\141Ab\238\208";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
