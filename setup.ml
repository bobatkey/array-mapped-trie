...
(* OASIS_START *)
(* DO NOT EDIT (digest: f09d7faf658bc1716708f4b8c1869e4d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["ArrayMappedTrie"; "ArrayMappedTrie_packed"];
                      lib_pack = false;
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "array-mapped-trie"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                     cs_name = "benchmark-array-mapped-trie";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\135;\174/\173\239NO%{\163.\233\238`\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
